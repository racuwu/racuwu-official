  ...
  return (
    <>
      ...
      <footer className="w-full text-slate-400">
              ...
              >
                ...
                <ul>
                  <li className="mb-2 leading-6">
                    <a
                      href="/avenues"
                      className="transition-colors duration-300 hover:text-[#D51067] focus:text-[#D51067]"
                    >
                      Avenues
                    </a>
                  </li>
                ...
                <ul>
                  <li className="mb-2 leading-6">
                    <a
                      ...
                      className="transition-colors duration-300 hover:text-[#D51067] focus:text-[#D51067]"
                    >
                      We are a professional voluntary movement that focuses on six avenues. We organize and participate in a variety of service projects, fundraisers, and social events. 
                    </a>
                  </li>
        ...
        <div className="py-4 text-sm border-t border-pink-900 bg-[#D51067] text-gray-100">
          <div className="container px-6 mx-auto">
            <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
              <div className="col-span-2 md:col-span-4 lg:col-span-6">
              © 2024 RACUWU.COM. All rights reserved.
              </div>
              <nav
              ...
              >
                ...
                <ul className="flex items-center justify-end gap-4">
                  <li>
                    <a
                      href="javascript:void(0)"
                      className="transition-colors duration-300 hover:text-[#D51067]"
                    >
                      <svg
